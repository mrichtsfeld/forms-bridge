...
class FBAPI
{
    ...
    {
        return apply_filters('forms_bridge_bridges', [], $addon);
    }
    ...
    {
        return apply_filters('forms_bridge_templates', [], $addon);
    }
    ...
    {
        return apply_filters('forms_bridge_jobs', []);
    }
    ...
    {
        return apply_filters('forms_bridge_jobs', [], $addon);
    }
