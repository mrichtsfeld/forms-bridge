<?php
/**
 * Dolibarr WooCommerce with product creation bridge template
 *
 * @package formsbridge
 */
...
return array(
	...
	'description'  => __(
		'Sale order bridge template. The resulting bridge will convert WooCommerce orders into sale orders linked to new contacts. <b>The template includes a job that synchronize products between WooCommerce and Dolibarr by product refs.</b>',
		'forms-bridge'
	),
