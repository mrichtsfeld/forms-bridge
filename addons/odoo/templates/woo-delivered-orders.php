...
return array(
	'title'        => __( 'Delivered Orders', 'forms-bridge' ),
	'description'  => __(
		'Sale order bridge template. The resulting bridge will convert WooCommerce orders into product delivered sale orders linked to new contacts. To work properly, <b>the bridge needs that you use your Odoo\'s product internal refrence as the WooCommerce product sku values</b>.',
		'forms-bridge'
	),
	...
	'bridge'       => array(
		...
		'workflow'      => array( 'contact', 'delivery-address', 'products-by-ref' ),
	),
);
