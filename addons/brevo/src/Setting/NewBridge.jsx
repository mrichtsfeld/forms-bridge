...
import BrevoTemplateWizard from "./TemplateWizard";
...
export default function NewBrevoBridge({ add, schema }) {
  return (
    <NewBridge add={add} schema={schema} Wizard={BrevoTemplateWizard}>
      {({ data, update }) => (
        <>
